...
@property(nonatomic,strong)UILabel * delegateFriends;
...
-(instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        _delegateFriends = [[UILabel alloc]init];
        _delegateFriends.font = [FontOutSystem fontWithFangZhengZhenSize:16.0];
        _delegateFriends.textAlignment = NSTextAlignmentCenter;
